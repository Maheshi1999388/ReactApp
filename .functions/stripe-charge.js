...
const stripe = __webpack_require__(17)('sk_test_51MJWBBFX0SgScDTmXMiyzzifAO7W0CGC2zEl68zFeQ3icXDisqPFPaw9K8skDExbxwtPRHBu3iWmY42u1mKrxu9f00nExLNRPv');
...
exports.handler = (() => {
    var _ref = _asyncToGenerator(function* (event) {
        ...
        const customer = yield stripe.customer.create({
            description: email,
            source: tokenId
        });
...
const {HttpClient} = __webpack_require__(5);
// Provide extension mechanism for Stripe Resource Sub-Classes
StripeResource.extend = utils.protoExtend;
// Expose method-creator
StripeResource.method = __webpack_require__(34);
...
const qs = __webpack_require__(20);
...
let exec = null;
try {
  exec = __webpack_require__(33).exec;
} catch (e) {
  // @ts-ignore
...
const StripeResource = __webpack_require__(2);
...
function getNodeCryptoProvider() {
  if (!webhooksNodeCryptoProviderInstance) {
    const NodeCryptoProvider = __webpack_require__(16);
...
const crypto = __webpack_require__(13);
const CryptoProvider = __webpack_require__(9);
/**
...
const _Error = __webpack_require__(4);
const resources = __webpack_require__(18);
const DEFAULT_HOST = 'api.stripe.com';
const DEFAULT_PORT = '443';
const DEFAULT_BASE_PATH = '/v1/';
const DEFAULT_API_VERSION = null;
const DEFAULT_TIMEOUT = 80000;
Stripe.PACKAGE_VERSION = __webpack_require__(124).version;
const utils = __webpack_require__(3);
...
const {HttpClient, HttpClientResponse} = __webpack_require__(5);
...
function Stripe(key, config = {}) {
  ...
  this._setApiKey(key);
  this.errors = _Error;
  this.webhooks = __webpack_require__(15);
...
Stripe.webhooks = __webpack_require__(15);
Stripe.createNodeHttpClient = (agent) => {
  const {NodeHttpClient} = __webpack_require__(125);
...
Stripe.createFetchHttpClient = (fetchFn) => {
  const {FetchHttpClient} = __webpack_require__(128);
...
Stripe.createSubtleCryptoProvider = (subtleCrypto) => {
  const SubtleCryptoProvider = __webpack_require__(129);
...
const resourceNamespace = __webpack_require__(19);
module.exports = {
  // Support Accounts for consistency, Account for backwards compatibility
  Account: __webpack_require__(10),
  AccountLinks: __webpack_require__(36),
  Accounts: __webpack_require__(10),
  ApplePayDomains: __webpack_require__(37),
  ApplicationFees: __webpack_require__(38),
  Balance: __webpack_require__(39),
  BalanceTransactions: __webpack_require__(40),
  Charges: __webpack_require__(41),
  CountrySpecs: __webpack_require__(42),
  Coupons: __webpack_require__(43),
  CreditNotes: __webpack_require__(44),
  Customers: __webpack_require__(45),
  Disputes: __webpack_require__(46),
  EphemeralKeys: __webpack_require__(47),
  Events: __webpack_require__(48),
  ExchangeRates: __webpack_require__(49),
  FileLinks: __webpack_require__(50),
  Files: __webpack_require__(51),
  InvoiceItems: __webpack_require__(53),
  Invoices: __webpack_require__(54),
  Mandates: __webpack_require__(55),
  OAuth: __webpack_require__(56),
  PaymentIntents: __webpack_require__(57),
  PaymentLinks: __webpack_require__(58),
  PaymentMethods: __webpack_require__(59),
  Payouts: __webpack_require__(60),
  Plans: __webpack_require__(61),
  Prices: __webpack_require__(62),
  Products: __webpack_require__(63),
  PromotionCodes: __webpack_require__(64),
  Quotes: __webpack_require__(65),
  Refunds: __webpack_require__(66),
  Reviews: __webpack_require__(67),
  SetupAttempts: __webpack_require__(68),
  SetupIntents: __webpack_require__(69),
  ShippingRates: __webpack_require__(70),
  Sources: __webpack_require__(71),
  SubscriptionItems: __webpack_require__(72),
  Subscriptions: __webpack_require__(73),
  SubscriptionSchedules: __webpack_require__(74),
  TaxCodes: __webpack_require__(75),
  TaxRates: __webpack_require__(76),
  Tokens: __webpack_require__(77),
  Topups: __webpack_require__(78),
  Transfers: __webpack_require__(79),
  WebhookEndpoints: __webpack_require__(80),
  Apps: resourceNamespace('apps', {
    Secrets: __webpack_require__(81),
  }),
  BillingPortal: resourceNamespace('billingPortal', {
    Configurations: __webpack_require__(82),
  ...
  FinancialConnections: resourceNamespace('financialConnections', {
    Accounts: __webpack_require__(85),
    Sessions: __webpack_require__(86),
  }),
  Identity: resourceNamespace('identity', {
    VerificationReports: __webpack_require__(87),
    VerificationSessions: __webpack_require__(88),
  }),
  Issuing: resourceNamespace('issuing', {
    Authorizations: __webpack_require__(89),
    Cardholders: __webpack_require__(90),
    Cards: __webpack_require__(91),
  ...
  Radar: resourceNamespace('radar', {
    ...
    ValueLists: __webpack_require__(96),
  }),
  ...
  Terminal: resourceNamespace('terminal', {
    Configurations: __webpack_require__(100),
    ConnectionTokens: __webpack_require__(101),
    Locations: __webpack_require__(102),
    Readers: __webpack_require__(103),
  }),
  TestHelpers: resourceNamespace('testHelpers', {
    Customers: __webpack_require__(104),
    Refunds: __webpack_require__(105),
    TestClocks: __webpack_require__(106),
    Issuing: resourceNamespace('issuing', {
      Cards: __webpack_require__(107),
    }),
    Terminal: resourceNamespace('terminal', {
      Readers: __webpack_require__(108),
    }),
    Treasury: resourceNamespace('treasury', {
      InboundTransfers: __webpack_require__(109),
      OutboundPayments: __webpack_require__(110),
      OutboundTransfers: __webpack_require__(111),
      ReceivedCredits: __webpack_require__(112),
      ReceivedDebits: __webpack_require__(113),
    }),
  }),
  Treasury: resourceNamespace('treasury', {
    CreditReversals: __webpack_require__(114),
    DebitReversals: __webpack_require__(115),
    FinancialAccounts: __webpack_require__(116),
    InboundTransfers: __webpack_require__(117),
    OutboundPayments: __webpack_require__(118),
    OutboundTransfers: __webpack_require__(119),
    ReceivedCredits: __webpack_require__(120),
    ReceivedDebits: __webpack_require__(121),
    TransactionEntries: __webpack_require__(122),
    Transactions: __webpack_require__(123),
  }),
};
...
var getSideChannel = __webpack_require__(22);
...
var utilInspect = __webpack_require__(30);
...
module.exports = __webpack_require__(31).inspect;
...
const utils = __webpack_require__(3);
const makeRequest = __webpack_require__(14);
const autoPagination = __webpack_require__(35);
...
const {multipartRequestDataProcessor} = __webpack_require__(52);
const StripeResource = __webpack_require__(2);
const stripeMethod = StripeResource.method;
module.exports = StripeResource.extend({
  create: stripeMethod({
...
const http = __webpack_require__(126);
const https = __webpack_require__(127);
const _HttpClient = __webpack_require__(5);
